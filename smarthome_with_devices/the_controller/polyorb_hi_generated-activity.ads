  ...
  is
    record
      case Port is
        ...
        when motion_out =>
          motion_out_DATA : PolyORB_HI_Generated.Types.motion_State;
        pragma Warnings (Off);
        when others =>
          null;
        pragma Warnings (On);
    ...
    record
      case Port is
        ...
        when motion_in =>
          motion_in_DATA : PolyORB_HI_Generated.Types.motion_State;
        when camera_out =>
          camera_out_DATA : PolyORB_HI_Generated.Types.motion_State;
        when light_out =>
          light_out_DATA : PolyORB_HI_Generated.Types.motion_State;
        when heat_out =>
          heat_out_DATA : PolyORB_HI_Generated.Types.motion_State;
        when music_out =>
          music_out_DATA : PolyORB_HI_Generated.Types.motion_State;
        when alarm_out =>
          alarm_out_DATA : PolyORB_HI_Generated.Types.motion_State;
        when gate_in =>
          gate_in_DATA : PolyORB_HI_Generated.Types.motion_State;
        when gate_out =>
          gate_out_DATA : PolyORB_HI_Generated.Types.motion_State;
        pragma Warnings (Off);
        when others =>
          null;
        pragma Warnings (On);
    ...
    record
      case Port is
        when motion_in =>
          motion_in_DATA : PolyORB_HI_Generated.Types.motion_State;
        when coffee_out =>
          coffee_out_DATA : PolyORB_HI_Generated.Types.motion_State;
        pragma Warnings (Off);
        when others =>
          null;
        pragma Warnings (On);
  ...
  is
    record
      case Port is
        ...
        when video_out =>
          video_out_DATA : PolyORB_HI_Generated.Types.motion_State;
        when video_not_recognized =>
          video_not_recognized_DATA : PolyORB_HI_Generated.Types.motion_State;
        pragma Warnings (Off);
        when others =>
